...
MODELS = {
    "seem": {
        ...
        # "config": f"{BASE_PATH}/xdecoder_seem/configs/seem/seem_focalt_lang.yaml",
        "checkpoint": f"{BASE_PATH}/xdecoder_seem/checkpoints/seem_focall_v1.pt",
        # "checkpoint": f"{BASE_PATH}/xdecoder_seem/checkpoints/seem_focalt_v1.pt",
    },
}
...
class RegionAlignedModel(VLFM):
    def __init__(self, name, **kwargs) -> None:
        ...
        if name == "seem":
            from openfusion_ros.zoo.xdecoder_seem.model import BaseModel
            from openfusion_ros.zoo.xdecoder_seem.xdecoder import build_model
            from openfusion_ros.zoo.xdecoder_seem.utils.distributed import init_distributed
            from openfusion_ros.zoo.xdecoder_seem.utils.arguments import load_opt_from_config_files
