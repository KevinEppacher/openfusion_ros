...
from openfusion_ros.utils.utils import relative_transform, kobuki_pose2rgbd
...
class BaseIO(object):
    ...
    def get_inputs(self):
        ...
        if self.with_pose:
            ...
            if 0 < pose_idx < len(state["pose_timestamps"]) and \
               abs(state["pose_timestamps"][pose_idx] - cam_ts) < abs(state["pose_timestamps"][pose_idx - 1] - cam_ts):
